import {test1, saveDataManga, getDataManga} from '../scripts/saveData.js';
...
export function displayData(){
    ...
    //console.log(preview);
    document.querySelector('.grid-manga').innerHTML = save;
    remove(preview);
    heart(preview);
    info(preview);
    showID(preview);
